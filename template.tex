...
\begin{enumerate}
  ...
  \item Recreate this document (expect put your name/info at the top) to get used to writing in \LaTeX and to see the types of things we can do when creating a document to convey statistical information. Make sure to commit and push your work using GitHub desktop as you finish each section.
\end{enumerate}
\textbf{Remark:} You will find the class Sweave cheatsheet to be \emph{incredibly} (\verb|\emph{incredibily}|) helpful.

\section{Word Processsing Tasks}
...
This part of the midterm is due Sunday November 14 by 5p. I will not accept late submissions. note that you may use this template to help build your introduction and methods sections, and you can use the work you did as a group during the datathon. Still, I expect this submission will be your own summary and extension of that work without collaboration.
...
The result is 40.8576274. Note that I did not type the result, but I used the \verb|\Sexpr{}| command.
...
\label{figure1} %we can now reference plot1
\end{center}
\end{figure}
...
\onecolumn
\section{Appendix}
Below is a table from a paper I'm currently working on. Without the analysis objects in R, I have to create this table myself.
...
Zero-Sum Poor (\emph{Z}) & 17.96 & 1.00 & 19.48 & $< 0.0001$ & 0.03 \\
...
White-Poor (\emph{Z}) x Zero-Sum (\emph{Z}) & 7.96 & 1.00 & 8.63 & 0.0034 & 0.01 \\
...
The \texttt{palmerpenguins} package for R \citep{palmerpenguins} provides data on adult foraging penguins near Palmer Station, Antarctica. Figure \ref{plot3} is too big to fit nicely in our column-based template above, so I've placed it here in the abstract by saving it and presenting it scaled to 0.75.
